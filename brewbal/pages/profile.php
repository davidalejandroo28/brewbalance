...
// Handle form submission to update the caffeine limit
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $new_limit_caffeine = $_POST['limit_caffeine'];

    // Update user data in the database
    $updateQuery = "UPDATE usercaffeinedata SET limit_caffeine = ? WHERE username = ?";
    $updateStmt = $conn->prepare($updateQuery);
    $updateStmt->bind_param("ds", $new_limit_caffeine, $username);
...
// Fetch the current caffeine limit from the database
